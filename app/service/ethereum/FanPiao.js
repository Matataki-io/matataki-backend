...
class FanPiaoService extends Web3Service {
  /**
   * getFanPiaoContract, 通过生成Fanpiao合约对象来进行各种操作（部署、测算gas费等...）
   ...
   */
  getFanPiaoContract(name, symbol, initialSupply, defaultOperators = []) {
  ...
  issueFanPiao(name, symbol, decimals, cap, initialSupply) {
    ...
    return new Promise((resolve, reject) => {
      this
        .getFanPiaoContract(name, symbol, initialSupply, [ '0x2F129a52aAbDcb9Fa025BFfF3D4C731c2D914932' ])
        // 发送交易
        .send({
